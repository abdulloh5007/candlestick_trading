        ...
        <div className="backdrop-blur rounded-2xl shadow-md border-solid border-2 border-gray-50">
          ...
          <form className='py-1' onSubmit={formik.handleSubmit}>
              ...
              <div className="textbox flex flex-col items-center gap-6">
                  ...
                  <button className="border bg-indigo-500 w-3/4 py-4 rounded-lg text-gray-50 text-xl shadow-sm text-center" type='submit'>Sign In</button>
              </div>

              <div className="text-center py-4">
                <span className='text-gray-500'>Forgot Password? <a className='text-red-500' to="/recovery">Recover Now</a></span>
              </div>
